...
| L028 | SECURE 2.0 Act (retirement/annuity law, enacted as Div. T of the 2023 omnibus) fits the "quietly lobbied" bucket: the retirement/annuity industry names it specifically in its own activity text across 2022-2026 (1,436 senate / 1,416 house filings) — Athene, Fidelity (FMR), American Benefits Council, HR Policy Association — while congressional press is near-silent (~54 releases name it corpus-wide, no dominant voice; top single member Chris Van Hollen x4). Surfaced by the new P2 bill cross-check as a tooling demo, not yet triaged. | P2 bill cross-check (free-text name match, say-vs-pay) | Athene Holding (Brownstein Hyatt); CHRO Association / HR Policy Association (Tributary LLP); American Benefits Council; FMR LLC / Fidelity (paid) · Chris Van Hollen; John B. Larson; Brendan F. Boyle (press) | open | unassigned | 50349204-4f47-471a-8c08-21f29a66a872 (Athene 2025 Q1 $280k, activity names "SECURE 2.0"); a855ea99-d047-4ffa-872c-afe8c3ec4c63 (Athene 2024 Q3 $240k); ec2ec9f3-db85-4b04-a55b-ba726d84884c (CHRO/HR Policy Assoc. 2022 Q4 $930k); press congress_press/2026-01.jsonl:2133 (Larson retirement bill names SECURE 2.0) | narrow to the retirement provisions via FREE-TEXT name match, not the omnibus number (HR2617 rides the whole 2023 appropriations bill and over-counts); test whether "quiet press" is real low-salience or a corpus gap; is any single client's ask (e.g. Athene / annuity RILA treatment) newsworthy on its own | 2026-07-07 |
