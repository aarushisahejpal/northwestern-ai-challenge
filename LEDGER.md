...
|---|---|---|---|---|---|---|---|---|
| L001 | Senate vs House income for the same org+client diverges systematically — dominant house=2×senate pattern suggests amendment double-counting (artifact?), but senate=2×house cases exist too | senate-house-discrepancy | Mercury Public Affairs/RAND & AITEO; S-3 Group/Pattern Energy & DoorDash; Alpine/Solana Policy Inst | open | — | sweep#H1 (20 pairs, deltas $50K–120K) | FIRST verify against raw XML: dedup amendments/refilings, re-run H1; only survivors are leads | 2026-07-04 |
...
| L004 | Bills heavily lobbied but publicly near-silent: HR7567 (358 lobby vs 5 press mentions), HR4552 (271 vs 1), S2296 (266 vs 1) | say-vs-pay | bills HR7567, HR4552, S2296 + their lobbying clients (TBD) | open | — | sweep#H2/C1; bill_mentions table | Identify bills via Congress.gov (disclose as outside data); list top clients lobbying each; why the silence | 2026-07-04 |
