...
FILE_DESC = {
 "crypto_players.csv": "MASTER TABLE — one row per entity-resolved client-side player with ≥1 crypto-tagged senate filing.",
 ...
 "crypto_ld203_recipients_split.csv": "Giving recipients split by giver type (crypto-native vs diversified core); person/Trump-inaugural name variants merged; top 400 rows.",
 "crypto_ld203_member_variant_audit.csv": "QA audit for the 2026-07-08 member merge: every raw filed recipient string behind every merged member row, per giver slice.",
 ...
 "crypto_member_support_rollup.csv": "P6 member support rollup: per member, direct giving per slice + tier-labeled committee support; JFC/multi-honoree money kept separate (never summed in).",
